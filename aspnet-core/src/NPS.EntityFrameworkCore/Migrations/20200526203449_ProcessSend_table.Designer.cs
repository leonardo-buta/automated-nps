...
namespace NPS.Migrations
{
    ...
    [Migration("20200526203449_ProcessSend_table")]
    partial class ProcessSend_table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NPS.Campaings.Campaign", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NPS.Messages.Message", b =>
                {
                    b.HasOne("NPS.Campaings.Campaign", "Campaing")
                        .WithMany()
            ...
            modelBuilder.Entity("NPS.SendProcesses.SendProcess", b =>
                {
                    b.HasOne("NPS.Campaings.Campaign", "Campaign")
                        .WithMany()
